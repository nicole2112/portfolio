...
export const projectsData: Array<Project> = [
    { id: 1, title: 'Project A', codeUrl: 'https://github.com/nicole2112/CHART2023', prodUrl: 'https://github.com/nicole2112/CHART2023', images: images, description: 'With less than a month to go before the European Union enacts new consumer privacy laws for its citizens, companies around the world are updating their terms of service agreements to comply.'},
